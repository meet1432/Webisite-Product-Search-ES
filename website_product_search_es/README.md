# Odoo Smart Search using Elasticsearch (Odoo 19)
...
- `Elasticsearch Index` (default: `odoo_products`)
- `Hide Out Of Stock`
- `Enable Autocomplete`
...
## Upgrade Note (Odoo 19)
- This module uses Odoo 19-compatible backend views and web assets.
- If upgrading from an older custom revision, restart Odoo and run module upgrade:
  - `-u website_product_search_es`
